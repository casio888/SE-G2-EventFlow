...
| Ziele & Aufgaben
| • Veranstalter: Events anlegen, Einreichungen strukturieren, Eventagenda erstellen, Beiträge zusagen/ablehen ohne den Überblick zu verlieren.
  • Einreicher: Passende Events finden, Beiträge unkompliziert einreichen und den Status der Bewerbung an einem zentralen Ort verfolgen.
  • Kernaufgabe: Bündelung der Kommunikation, um manuelle Rückfragen zu minimieren.
 
| Ressourcen
| • Hardware: Desktop-PCs und Laptops (z. B. 15" Laptop, Surface Pro 5) für die Hauptverwaltung; Smartphones (z. B. iPhone 11) für schnelle Checks und mobile Antworten.
  • Software: Webbrowser; die Anwendung muss ohne komplizierte Einrichtung („kein Tech-Pro nötig“) funktionieren.
  • Input: Tastatur/Maus für Planung, Touch-Bedienung für unterwegs.
 
| Umgebung
| • Technische Umgebung: Überall verfügbar (Web-basiert) wo es Zugang zum Internet gibt.
  • Physische Umgebung: Nutzung im Büro oder Home-Office (fokussiertes Arbeiten), aber auch unterwegs/mobil (unter Zeitstress, in der Freizeit oder direkt vor Ort beim Event).
  • Soziale & organisatorische Umgebung: Geprägt durch hohen Zeitdruck, Koordinationsaufwand mit vielen Beteiligten und das Bedürfnis nach schneller Information bei Unterbrechungen.
