...
| Benutzer
a|
Die Nutzerschaft ist heterogen und reicht von studentischen Gelegenheits-Organisatoren (Lukas, 25) über professionelle Festivalplaner (Jargen, 28) bis hin zu externen Einreichern/Künstlern (Mark, 32).

* Kenntnisse: Reichen von durchschnittlicher Web-Affinität bis zu Expertenwissen in Event-Software.
